from .protree_data.river_generators import Mixed
from .base import BaseDataset
import pandas as pd


class MixedMultiWindowDataset(BaseDataset):
    @property
    def name(self) -> str:
        return "mixed_multi_window"

    @property
    def display_name(self) -> str:
        return "Mixed Multi-Window"

    def get_params(self) -> dict:
        params = super().get_params()
        params.update(
            {"num_windows": 100, "drift_positions": [28000, 52000, 70000], "drift_duration": 1, "classification_function": 1}
        )
        return params
    ...
    def generate(
        ...
        **kwargs,
        ...
        """
        Generate synthetic data stream using protree's Mixed generator.
        ...
        classification_function : int
            Classification function (0 or 1)
        random_seed : int
        ...
        classification_function = classification_function % 2
