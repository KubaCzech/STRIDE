from .protree_data.river_generators import Sea
from .base import BaseDataset
import pandas as pd


class SeaMultiWindowDataset(BaseDataset):
    @property
    def name(self) -> str:
        return "sea_multi_window"

    @property
    def display_name(self) -> str:
        return "SEA Multi-Window"
    ...
    def generate(self, num_windows=100, window_length=1000, drift_positions=None, drift_duration=1, random_seed=42, **kwargs):
        ...
        # Create SEA generator
        ds = Sea(drift_position=drift_positions if drift_positions else 500, drift_duration=drift_duration, seed=random_seed)
