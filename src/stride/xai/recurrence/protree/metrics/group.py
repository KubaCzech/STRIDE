...
from stride.xai.recurrence.protree import TPrototypes, TDataBatch, TTarget
from stride.xai.recurrence.protree.explainers.tree_distance import IExplainer
from stride.xai.recurrence.protree.metrics.classification import balanced_accuracy
...
def contribution(prototypes: TPrototypes, explainer: IExplainer, x: TDataBatch) -> float:
    from stride.xai.recurrence.protree.metrics.individual import individual_contribution
...
def mean_in_distribution(prototypes: TPrototypes, explainer: IExplainer, x: TDataBatch, y: TTarget) -> float:
    from stride.xai.recurrence.protree.metrics.individual import individual_in_distribution
...
def mean_out_distribution(prototypes: TPrototypes, explainer: IExplainer, x: TDataBatch, y: TTarget) -> float:
    from stride.xai.recurrence.protree.metrics.individual import individual_out_distribution
...
def vector_entropy_hubness(prototypes: TPrototypes, explainer: IExplainer, x: TDataBatch) -> dict[str | bool | int, float]:
    ...
    from stride.xai.recurrence.protree.metrics.individual import hubness
...
def vector_consistent_votes(prototypes: TPrototypes, explainer: IExplainer, x: TDataBatch) -> dict[str | bool | int, float]:
    from stride.xai.recurrence.protree.metrics.individual import consistent_votes
...
def vector_voting_frequency(prototypes: TPrototypes, explainer: IExplainer, x: TDataBatch) -> dict[str | bool | int, float]:
    from stride.xai.recurrence.protree.metrics.individual import voting_frequency
...
def vector_in_distribution(
    prototypes: TPrototypes, explainer: IExplainer, x: TDataBatch, y: TTarget
